...
GROUP BY band_id
HAVING P1>(SELECT AVG(P2) FROM( SELECT band_id,COUNT(player) as P2
FROM band,plays_in
WHERE band_id=band_no
GROUP BY band_id)As tabla;*/
...
--POBLAR OK--
INSERT INTO musician VALUES(23,'John Smith',TO_DATE('1958/02/01','YYYY/MM/DD'),null,6,4);
INSERT INTO performer VALUES(30,6,'violin','jazz');
INSERT INTO band VALUES(10,'Somebody <3',1,'jazz',null,6);
INSERT INTO plays_in VALUES(3,8);
INSERT INTO plays_in VALUES(2,7);
...
INSERT INTO place VALUES(Z,'Manchester','England');
INSERT INTO musician VALUES(a,'Fred Bloggs',TO_DATE('1948/01/02','YYYY/MM/DD'),null,1,2);
INSERT INTO musician VALUES('x','Fred Bloggs',TO_DATE('ENERO/01/02','YYYY/MM/DD'),null,1,2);
INSERT INTO plays_in VALUES(29,7);
INSERT INTO musician VALUES("22",'Steven Chaytors',TO_DATE('1956/03/11','YYYY/MM/DD'),null,"6","7");
